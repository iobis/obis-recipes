...
![](reference/figures/README-ggplot-example-1.png)
...
![](reference/figures/README-ggplot-example2-1.png)
...
![](reference/figures/README-colorbar-light-1.png)
...
![](reference/figures/README-colorbar-dark-1.png)
...
![](reference/figures/README-static-basemap-1.png)
...
![](reference/figures/README-static-species-1.png)
...
![](reference/figures/dynamic-map1.png)
...
![](reference/figures/dynamic-map2.png)
...
![](reference/figures/dynamic-map3.png)

![](reference/figures/dynamic-map4.png)

![](reference/figures/dynamic-map5.png)

## Vignettes

| Vignette | Topic |
|----|----|
| [`vignette("ggplot-styles", package = "obisrecipes")`](https://iobis.github.io/obis-recipes/articles/ggplot-styles.md) | Themes, color scales, colourbar guide, logo overlay |
| [`vignette("static-maps", package = "obisrecipes")`](https://iobis.github.io/obis-recipes/articles/static-maps.md) | Basemaps, grid converters, offline and API-based plotting |
| [`vignette("dynamic-maps", package = "obisrecipes")`](https://iobis.github.io/obis-recipes/articles/dynamic-maps.md) | Interactive WebGL maps and the H3 widget |
...
Developed by the [OBIS Secretariat](https://obis.org) · Operating under
